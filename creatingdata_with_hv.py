...
l = int(x_train.shape[0]/2)
with open(data_out + '_0', 'wb') as fout:
    pickle.dump((x_train[0:l], y_train[0:l]), fout)

with open(data_out + '_1', 'wb') as fout:
    pickle.dump((x_train[l:], y_train[l:]), fout)
print (datetime.time())
