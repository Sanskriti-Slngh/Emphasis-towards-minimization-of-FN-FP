...
history = LossHistory()
#model_name = 'models/model_103_data_aug_d50p_k_fold'
model_name ='models/model_105_d80p_multi_classification'
...
if not os.path.isfile(model_name + '.h5py') or reset_model:
    ...
    if model_name == 'models/model_103' or model_name == 'models/model_103_d50p' \
            ...
            model_name == 'models/model_103_nih' or model_name == 'models/model_103_nih_d50_nofold' or \
            model_name == 'models/model_103_multi_class' or model_name == 'models/model_103_d50p_multi_class' or \
            model_name == 'models/model_103_3layers_d50p_multi_class':
        ...
        model.add(Conv2D(512, (3, 3), padding='same', activation='relu'))
        model.add(MaxPooling2D(pool_size=(3, 3), padding='same', strides=2))
        if model_name == 'models/model_103_3layers_d50p_multi_class':
        ...
        if model_name == 'models/model_103_d50p' or \
            model_name == 'models/model_103_data_aug_d50p_k_fold' or \
            model_name == 'models/model_103_nih_d50_nofold' or model_name == 'models/model_103_d50p_multi_class':
            model.add(Dropout(0.5))
        elif model_name == 'models/model_103_d80p':
            model.add(Dropout(0.8))
        elif model_name == 'models/model_103_3layers_d50p_multi_class':
            model.add(Dropout(0.5))
        model.add(Flatten())
        if model_name == 'models/model_103_multi_class':
            model.add(Dense(15, activation=tf.nn.sigmoid))
        else:
            model.add(Dense(15, activation=tf.nn.sigmoid))

    elif model_name == 'models/model_105' or model_name == 'models/model_105_d50p' or model_name == 'models/model_105_d80p_multi_classification' or model_name == 'models/model_105_adam' or model_name == 'models/model_105_rms_prop' or model_name == 'models/model_105_k_fold':
        model.add(Conv2D(64, (3, 3), padding='same', activation='relu', input_shape=(256, 256, 1)))
        model.add(Conv2D(64, (3, 3), padding='same', activation='relu'))
        model.add(MaxPooling2D(pool_size=(3, 3), padding='same', strides=2))
        model.add(Conv2D(128, (3, 3), padding='same', activation='relu'))
    ...
    elif model_name == 'Saved_previous_models/model_105_d50p_multi_class' or model_name == 'Saved_previous_models/abc_multi_class':
        model.add(Conv2D(64, (3, 3), padding='same', activation='relu', input_shape=(256, 256, 1)))
        model.add(Conv2D(64, (3, 3), padding='same', activation='relu'))
        model.add(MaxPooling2D(pool_size=(3, 3), padding='same', strides=2))
        model.add(Conv2D(128, (3, 3), padding='same', activation='relu'))
